...
## AMDS & Bonjour Services

1. Press Win + R to open the Run dialog, type `services.msc`, and click OK to open the Services window.

![Open services.msc](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713141049044.png){style="width:25rem;"}
...
![Open Properties](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713141143533.png){style="width:20rem;"}

4. Set Startup type to Automatic and click OK.

![Change the startup type](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713141545692.png){style="width:30rem;"}

5. Right-click the service again and choose Restart. (Do the same for AMDS.)

![Restart the service](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713141739672.png){style="width:20rem;"}


## Reinstall iTunes

If AMDS and Bonjour services are missing, reinstall iTunes.
...
![Uninstall a program](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713141931566.png){style="width:30rem;"}


3. Right-click to uninstall both Bonjour and iTunes.

:::{layout-ncol=2}
![Uninstall Bonjour](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713142026540.png){width="90%"}

![Uninstall iTunes](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713142827075.png){width="80%"}
:::
...
![Uninstall iTunes from the Start menu](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713142217287.png){style="width:20rem;"}
...
![Looking for other versions](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713142515831.png){style="width:35rem;"}

![Download iTunes for Windows](https://raw.githubusercontent.com/Pinn32/img/main/img/pic-go/20260713142938059.png){style="width:35rem;"}
